 ...
 */
class Provincia extends \Frontend\Bundle\Entity\Provincia implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setNombreProvincia($nombreProvincia);
    }

    public function getNombreProvincia()
    {
        $this->__load();
        return parent::getNombreProvincia();
    }

    public function setRegionPk(\Frontend\Bundle\Entity\Region $regionPk = NULL)
    {
        $this->__load();
        return parent::setRegionPk($regionPk);
    }

    public function getRegionPk()
    {
        $this->__load();
        return parent::getRegionPk();
    }
