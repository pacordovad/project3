...
class __TwigTemplate_2eba59d08ce4b6318a4eb85de15a479283ac2f161be7b62a4c23837c7a5c2af0 extends Twig_Template
{
    ...
    <table class=\"tColapse records_list t_control\" id=\"datatable_crud_pedidos\" style=\"font-size: 11px\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            echo "')\" ";
            if (($this->env->getExtension('security')->isGranted("ROLE_COORDINADOR") || ($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "user"), "id") == $this->getAttribute($this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "delegado3UsuarioPk"), "id")))) {
            } else {
                echo "disabled";
            }
            echo ">
