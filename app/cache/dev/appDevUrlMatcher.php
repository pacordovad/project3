...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/css')) {
            if (0 === strpos($pathinfo, '/css/b9ccb8c')) {
                // _assetic_b9ccb8c
                if ($pathinfo === '/css/b9ccb8c.css') {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => 'b9ccb8c',  'pos' => NULL,  '_format' => 'css',  '_route' => '_assetic_b9ccb8c',);
                }

                // _assetic_b9ccb8c_0
                if ($pathinfo === '/css/b9ccb8c_jquery.dataTables_1.css') {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => 'b9ccb8c',  'pos' => 0,  '_format' => 'css',  '_route' => '_assetic_b9ccb8c_0',);
                }

            }

            if (0 === strpos($pathinfo, '/css/1c983ea')) {
                // _assetic_1c983ea
                if ($pathinfo === '/css/1c983ea.css') {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => '1c983ea',  'pos' => NULL,  '_format' => 'css',  '_route' => '_assetic_1c983ea',);
                }

                if (0 === strpos($pathinfo, '/css/1c983ea_')) {
                    if (0 === strpos($pathinfo, '/css/1c983ea_bootstrap')) {
                        // _assetic_1c983ea_0
                        if ($pathinfo === '/css/1c983ea_bootstrap.min_1.css') {
                            return array (  '_controller' => 'assetic.controller:render',  'name' => '1c983ea',  'pos' => 0,  '_format' => 'css',  '_route' => '_assetic_1c983ea_0',);
                        }

                        // _assetic_1c983ea_1
                        if ($pathinfo === '/css/1c983ea_bootstrap-theme.min_2.css') {
                            return array (  '_controller' => 'assetic.controller:render',  'name' => '1c983ea',  'pos' => 1,  '_format' => 'css',  '_route' => '_assetic_1c983ea_1',);
                        }

                    }

                    // _assetic_1c983ea_2
                    if ($pathinfo === '/css/1c983ea_main_3.css') {
                        return array (  '_controller' => 'assetic.controller:render',  'name' => '1c983ea',  'pos' => 2,  '_format' => 'css',  '_route' => '_assetic_1c983ea_2',);
                    }
        ...
        if (0 === strpos($pathinfo, '/js/25d9041')) {
            // _assetic_25d9041
            if ($pathinfo === '/js/25d9041.js') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => '25d9041',  'pos' => NULL,  '_format' => 'js',  '_route' => '_assetic_25d9041',);
            }

            if (0 === strpos($pathinfo, '/js/25d9041_')) {
                // _assetic_25d9041_0
                if ($pathinfo === '/js/25d9041_jquery-1.10.2_1.js') {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => '25d9041',  'pos' => 0,  '_format' => 'js',  '_route' => '_assetic_25d9041_0',);
                }

                // _assetic_25d9041_1
                if ($pathinfo === '/js/25d9041_main_2.js') {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => '25d9041',  'pos' => 1,  '_format' => 'js',  '_route' => '_assetic_25d9041_1',);
                }
        ...
        if (0 === strpos($pathinfo, '/css/0d49e82')) {
            // _assetic_0d49e82
            if ($pathinfo === '/css/0d49e82.css') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => '0d49e82',  'pos' => NULL,  '_format' => 'css',  '_route' => '_assetic_0d49e82',);
            }

            // _assetic_0d49e82_0
            if ($pathinfo === '/css/0d49e82_jquery-ui-1.10.3.custom.min_1.css') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => '0d49e82',  'pos' => 0,  '_format' => 'css',  '_route' => '_assetic_0d49e82_0',);
            }

        }

        if (0 === strpos($pathinfo, '/js')) {
            if (0 === strpos($pathinfo, '/js/3b8dad4')) {
                // _assetic_3b8dad4
                if ($pathinfo === '/js/3b8dad4.js') {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => '3b8dad4',  'pos' => NULL,  '_format' => 'js',  '_route' => '_assetic_3b8dad4',);
                }

                // _assetic_3b8dad4_0
                if ($pathinfo === '/js/3b8dad4_jquery.dataTables-1.9.4.min_1.js') {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => '3b8dad4',  'pos' => 0,  '_format' => 'js',  '_route' => '_assetic_3b8dad4_0',);
                }
