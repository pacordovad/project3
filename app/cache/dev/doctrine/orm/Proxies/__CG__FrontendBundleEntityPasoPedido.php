 ...
 */
class PasoPedido extends \Frontend\Bundle\Entity\PasoPedido implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setNombrePaso($nombrePaso);
    }

    public function getNombrePaso()
    {
        $this->__load();
        return parent::getNombrePaso();
    }
